...
timer.performWithDelay (1000,function() -- determminou que apos 1000 milesegundos vai ativar uma função temporaria de moeda1
    local moeda1 = scriptColetavel.novaMoeda (math.random (0,480),-100) -- chama dentro da moeda1, a funcao novaMoeda, que esta dentro do Coletavel.lua, e dentro dessa função estao localização x (x=math.random) y = -100
end,0,"timerMoeda") -- fecha função, quantidade de repetição - no caso o zero é infinito, e dpeois o nome do timer